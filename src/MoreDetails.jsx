    ...
    return ( 
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-5xl flex flex-col md:flex-row"> 
              ...
              <div> 
                ...
                <div className="flex gap-4 mb-2 "> 
                  <input className="bg-white border-2 h-10 w-14" 
                          type="number" min="1" value={count} 
                          onChange={handleCountChange}>
                  </input> 
                  <button 
                        onClick={handleButtonClick} 
                        className="bg-red-500 text-white px-4 h-10 py-2 rounded whitespace-nowrap hover:bg-red-700">
                          Add to Cart
                  </button> 
                </div> 
              </div> 
        ...
        <div className='flex justify-between'> 
          <div> 
              ...
              <HiArrowNarrowLeft className="text-2xl" /> <span className="text-lg font-medium">Previous</span> 
              </Link>} 
          </div> 
          <div> 
